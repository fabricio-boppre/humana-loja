...
export default function Masthead(props) {
  ...
  useEffect(() => {
    ...
    if (isIE11()) {
      ...
      const divIncompatibleBrowser = document.getElementById(
      ...
      Snipcart.api.session.setLanguage("pt-BR", {
        ...
        errors: {
          card: {
            ...
            declined:
              "Seu cartão foi rejeitado. Entre em contato com o seu banco para mais informações.",
          ...
          transaction: {
            declined:
              "Houe um erro no processamento do seu cartão. Por gentileza, tente novamente.",
          },
          discounts: {
            conflict:
              "Alguns descontos não podem ser utilizados conjuntamente. Usar este desconto?",
          },
          shippingRates: {
        ...
        payment: {
          form: {
            deferred_payment_title:
              "Pagamento posterior via transação bancária ou Pix",
            deferred_payment_instructions:
              "Você receberá em seu email as instruções para o pagamento via Pix ou transferência bancária com o recibo de seu pedido. Em caso de dúvidas, entre em contato pelo nosso WhatsApp: (49) 3316-4566.",
        ...
        register_form: {
          requires_action: {
            ...
            description:
              "Este endereço de email já foi utilizado em uma compra anterior. Para completar o seu registro, verifique a mensagem que acabamos de lhe enviar.",
          },
        },
        shipping: {
  ...
  return (
    <header id={styles.masthead}>
      <div id="masthead-nucleus">
        <Link href="/">
          <a
            id="masthead-logotipo"
            onClick={isHome ? undefined : () => props.handleHomeClicked()}
          >
