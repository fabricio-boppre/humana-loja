...
export default function AccountButton() {
	...
	useEffect(() => {
		document.addEventListener('snipcart.ready', function() {
			const divSnipcartAccountButton = document.getElementById(styles.account_button)
  ...
  return (
		<div id={styles.account_button} className="snipcart-customer-signin">{userNotSignedMessage}</div>
	)
